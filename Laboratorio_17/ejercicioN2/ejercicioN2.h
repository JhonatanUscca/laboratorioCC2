...
class lista {
    ...
    public:
        lista (){}  
        ~lista (){}  
        void ingresarFinal(Plista &lista, T valor)
        {
            contador++;
            Plista a, b = new(nodo<int>);
        ...
        void ingresarInicio(Plista &lista, T valor)
        {
            contador++;
            Plista a;
            a = new(nodo<int>);
        ...
        void ingresarElemento(Plista &lista, T valor, int posicion)
        {
            Plista a, b;
            int i;
            a = new(nodo<int>);
        ...
        void random(Plista &lista, int cantidad, T numMax)
        {
            T num, c;
            clock_t t;
            T ini = 1.0;
            ...
            random_device rd;  
            mt19937 gen(rd());
            uniform_int_distribution<> dist(ini,numMax);
